...
import { get_exam_apptitude_questions } from '../api/get_question';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className={`flex items-center px-3 py-2 rounded-lg ${timeLeft < 300 ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
                ...
                <span className="font-mono font-semibold">{typeof formatTime === 'function' ? formatTime() : '00:00'}</span>
              </div>
      ...
      {showViolationWarning && (
        <div className="bg-red-500 text-white px-4 py-2 text-center">
          <p className="font-medium">⚠️ Security Violation Detected! Avoid switching tabs or leaving the exam window.</p>
        </div>
      )}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">{questions.length - Object.keys(selectedAnswers).length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="flex items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">{
                    Array.from(markedForReview).filter(id => selectedAnswers[id] !== undefined).length
                  }</span>
                </div>
              </div>
            </div>
