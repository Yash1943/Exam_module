...
const ExamInterface = ({ onExamComplete }) => {
  ...
  useEffect(() => {
    ...
    const handleFullscreenChange = () => {
      if (!document.fullscreenElement && 
        ...
        // If user exits fullscreen, try to re-enable it
        enableFullScreen();
      }
    };
  ...
  const parseTime = (timeString) => {
    ...
    // Handle format HH:MM
    const shortTimeMatch = timeString.match(/(\d+):(\d+)/);
    if (shortTimeMatch) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-50 overflow-auto">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div
                ...
                <span className="font-mono font-semibold">
                  {typeof formatTime === "function" ? formatTime(timeLeft) : "00:00"}
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 h-[calc(100vh-80px)] overflow-auto">
